...
// This script will generate 500+ users for testing discovery
// Usage: Run it in your browser or via CLI: http://localhost/dating_api/seed_users.php
...
$lifestyles = ["Active", "Casual", "Professional", "Creative"];
...
for ($i = 1; $i <= 500; $i++) {
    ...
    if ($stmt->execute()) {
        ...
        // Using Picsum for varied high-quality images
        $photo1 = "https://picsum.photos/seed/u{$userId}a/600/800";
        $photo2 = "https://picsum.photos/seed/u{$userId}b/600/800";
        
        $db->query("INSERT INTO user_photos (user_id, image_url, is_main) VALUES ($userId, '$photo1', 1)");
        $db->query("INSERT INTO user_photos (user_id, image_url, is_main) VALUES ($userId, '$photo2', 0)");
